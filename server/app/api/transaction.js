...
module.exports = app => {
    ...
    let runExpressValidator = (req) => {
        ...
        req.assert("amount", "transaction.amount is required and must be a number greater than zero").notEmpty().isNumber().gte(1);
        req.assert("amount", "insuficient funds").lte(1);
